	...
	<body class="contact loading">
			...
			<header id="header"><?php include('header.php'); ?></header>	
					...
					<?php
						if (isset($_REQUEST['submitted'])) 
						{
							...
							$to1 = "khoslastuti16@gmail.com";

							$headers = "From: TheBookHub (article)"; 
							$message = "Message from " . $name . " Email: " . $email . " Title: " . $subject . " Text: \n\n" . $text ;
		...
		<!-- Main -->
			<article id="main">
			    ...
			    <h2>Thank you</h2>
					<p>Your article is under review. You will be notified when it's published.</p>
					<p>Till then, Please have a look at other articles on <a href="http://blog.thebookhub.in">The Book Blog</a></p>
				</header>
