...
<html>
	<head><link rel="image_src" href="http://thebookhub.in/logo.png" />
		...
		<title>The Book Hub|Download</title>        
  ...
  ga('send', 'pageview');
		...
		<!-- Header -->
			...
			<article id="main">
				...
				<header class="special container">
					...
					<h2>A collection of popular titles<strong></strong></h2>
				...
				<!-- One -->
					<section class="wrapper style4 container">
						...
						<!-- Content -->
							<div class="content">
							<p>In case you are looking for course related books, <a href="http://mit.thebookhub.in">click here.</a></p>
								<section>
    ...
    <p>If you are unable to view the docs above, <a href="https://drive.google.com/folderview?id=0B1gmCFsAUVsOZWtBSGFmZlVMNTg&usp=sharing" target="_new">click here.</a></p>
		
									
									<p>Loved a book? <a href="review.php">Tell us about it!</a></p>
									<p>Read <a href="disclaimer.php">Disclaimer</a></p>
