...
<html>
	<head><link rel="image_src" href="http://thebookhub.in/logo.png" />
    	...
    	<link rel="Shortcut Icon" href="images/16x.png" type="image/png" />
		...
		<!-- Main -->
			<article id="main">
			  ...
			  <header class="special container">
			    ...
			    <h2>Disclaimer</h2>
				<p>Welcome to The Book Hub. The use of this website  is subject to the following terms of use:</p>
                <p></p>
                <p>                The content of the pages of this website is for your general  information and use only. It is subject to change without notice.</p>
					...
					<p>					  None of the documents available on The Book Hub are owned by us. They are all sourced from various freeshare websites and blogs for the  benefit of everyone. We do not own or claim to own any copyrights of these  documents.</p>
					<p>All the rights on the ebooks are the property of their respective owners. If you liked an ebook, please show  your appreciation by buying it from the author's page.</p>
					<p>We respect Copyright Laws. If you find any illegal file, please report it to us. We will remove the file within 7-10 business days.</p>
              </header>
                
                <center><a href="http://thebookhub.in/"> <input type="submit" class="button special" value="Go back to Home" name="submitted"></a></center>
