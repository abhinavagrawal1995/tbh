		...
		<!-- Header -->
			...
			<article id="main">
				...
				<header class="special container">
					...
					<h2>Story stuck in your head?</h2>
					<p>Pen it down. We'll publish it!</p>
				</header>
				...
				<!-- One -->
					<section class="wrapper style4 special container small">
						...
						<!-- Content -->
							<div class="content">
								<form action="articled.php" method="POST">
									...
									<div class="row half no-collapse-1">
										...
										<div class="6u">
											<input type="text" name="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Invalid email ID" required />
										</div>
									</div>
									<div class="row half">
										<div class="12u">
											<input type="text" name="subject" placeholder="Heading/Title" required/>
										</div>
									</div>
									<div class="row half">
										<div class="12u">
											<textarea name="text" placeholder="Article/Story" rows="7" required></textarea>
										</div>
									</div>
									<div class="row">
										<div class="12u">
											<ul class="buttons">
												<li><input type="submit" class="button special" value="Publish!" name="submitted"></input></li>
											</ul>
										</div>
									</div>
								</form>
