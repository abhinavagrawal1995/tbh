...
<html>
	<head><link rel="image_src" href="http://thebookhub.in/logo.png" />
		...
		<title>The Book Hub|Borrow</title>        
			...
			<article id="main">
			  ...
			  <header class="special container">
			    ...
			    <h2>The manipal library</h2>
					<p>Here's a list of books and their owners in Manipal. You may contact them to borrow the books you need.</p>
...
<th style=\"border:1px solid black;\">Hostel</th>
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo "<td style=\"border:1px solid black;unicode-bidi:bidi-override; direction: rtl;\" align=\"center\">" . strrev($row['Mobile']) . "</td>";
  echo "<td style=\"border:1px solid black;\" align=\"center\">" . $row['Hostel'] . "</td>";
  echo "<td style=\"border:1px solid black;unicode-bidi:bidi-override; direction: rtl;\" align=\"center\">" . strrev($row['Email']) . "</td>";
  echo "</tr>";
}
...
?>
                ...
                <center><a href="http://mit.thebookhub.in/submit.php"> <input type="submit" class="button special" value="Add a book to the collection" name="submitted"></a></center>
					</section>
			<!-- One -->
