...
<html>
	<head><link rel="image_src" href="http://thebookhub.in/logo.png" />
		...
		<title>The Book Hub|Submit</title>        
		...
		<!-- Header -->
			...
			<article id="main">
				...
				<header class="special container">
					...
					<h2>Do you own a book?</h2>
					<p>Share it with a fellow bookworm!</p>
				</header>
							...
							<div class="content">
								<form action="submitted.php" method="POST">
									...
									<div class="row half no-collapse-1">
										<div class="6u">
											<input type="text" name="title" placeholder="Name of the Book" required/>
										</div>
									...
									<div class="row half no-collapse-1">
										...
										<div class="6u">
											<input type="text" name="block" placeholder="Hostel block" required/>
										</div>
									...
									<div class="row">
										<div class="12u">
											<ul class="buttons">
												<li><input type="submit" class="button special" value="Add to the list" name="submitted">
												  </input></li>
											</ul>
										</div>
									</div>
