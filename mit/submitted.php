		...
		<!-- Header -->
			...
			<article id="main">
				...
				<header class="special container">
					...
					<h2>Thank you. Your Name will be added soon!</h2>
				</header>
								...
								<?php
									if (isset($_POST['submitted'])) 
									{
											  ...
											  $name = $_POST["name"];
												...
												$message = "Message from " . $name . " \nEmail: " . $email . "\nphone: " . $number . "\nblock: " . $block. "\r\nSQL: 	" . "insert into a3986955_books.list values('$subject','$name','$number','$block','$email');" ;
												$headers = "From: TheBookHub (Submit Books)"; 

												mail($to,$subject,$message,$headers);
											  
									}
								?>
								<p>To see the response list, <a href="http://mit.thebookhub.in/borrow.php">click here.</a></p>
								<p>Looking for pdfs of course books? <a href="http://mit.thebookhub.in/course.php" target="_new">Take a look at our online collection.</a></p>
							</div>
							
					</section>
					<center><a href="http://mit.thebookhub.in/submit.php"> <input type="submit" class="button special" value="Submit another book" name="submitted"></a></center>
